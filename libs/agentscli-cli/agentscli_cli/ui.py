...
def show_help() -> None:
    ...
    console.print("  agentscli [OPTIONS]                           Start interactive session")
    console.print("  agentscli list                                List all available agents")
    console.print("  agentscli reset --agent AGENT                 Reset agent to default prompt")
    console.print(
        "  agentscli reset --agent AGENT --target SOURCE Reset agent to copy of another agent"
    )
    console.print("  agentscli help                                Show this help message")
    console.print("  agentscli --version                           Show agentscli version")
    console.print()
    ...
    console.print(
        "  agentscli                              # Start with default agent", style=COLORS["dim"]
    )
    console.print(
        "  agentscli --agent mybot                # Start with agent named 'mybot'",
        style=COLORS["dim"],
    )
    console.print(
        "  agentscli --model gpt-4o               # Use specific model (auto-detects provider)",
        style=COLORS["dim"],
    )
    console.print(
        "  agentscli -r                           # Resume most recent session",
        style=COLORS["dim"],
    )
    console.print(
        "  agentscli -r abc123                    # Resume specific thread",
        style=COLORS["dim"],
    )
    console.print(
        "  agentscli --auto-approve               # Start with auto-approve enabled",
        style=COLORS["dim"],
    )
    console.print(
        "  agentscli --sandbox runloop            # Execute code in Runloop sandbox",
        style=COLORS["dim"],
    )
    console.print()
    ...
    console.print(
        "  agentscli threads list                 # List all sessions", style=COLORS["dim"]
    )
    console.print(
        "  agentscli threads delete <ID>          # Delete a session", style=COLORS["dim"]
    )
    console.print()
