...
It wraps the prebuilt middleware functionality from agentscli.middleware.skills and adapts
...
from agentscli.middleware.skills import SkillMetadata
from agentscli.middleware.skills import _list_skills as list_skills_from_backend
