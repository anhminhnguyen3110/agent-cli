...
from agentscli_cli.config import COLORS, console
...
async def list_threads_command(
    ...
    """CLI handler for: agentscli threads list."""
    ...
    if not threads:
        ...
        console.print("[dim]Start a conversation with: agentscli[/dim]")
        return
...
async def delete_thread_command(thread_id: str) -> None:
    """CLI handler for: agentscli threads delete."""
