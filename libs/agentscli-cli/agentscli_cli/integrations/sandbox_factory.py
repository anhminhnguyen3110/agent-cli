...
from agentscli.backends.protocol import SandboxBackendProtocol

from agentscli_cli.config import console
...
def create_runloop_sandbox(
    *, sandbox_id: str | None = None, setup_script_path: str | None = None
    ...
    from agentscli_cli.integrations.runloop import RunloopBackend
...
def create_daytona_sandbox(
    *, sandbox_id: str | None = None, setup_script_path: str | None = None
    ...
    from agentscli_cli.integrations.daytona import DaytonaBackend
