"""Textual UI application for agentscli-cli."""
...
from agentscli_cli.clipboard import copy_selection_to_clipboard
from agentscli_cli.textual_adapter import TextualUIAdapter, execute_task_textual
from agentscli_cli.widgets.approval import ApprovalMenu
from agentscli_cli.widgets.chat_input import ChatInput
from agentscli_cli.widgets.loading import LoadingWidget
...
class AgentsCLIApp(App):
    """Main Textual application for agentscli-cli."""
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """Initialize the AgentsCLI application.
    ...
    async def _handle_command(self, command: str) -> None:
        ...
        if cmd in ("/quit", "/exit", "/q"):
            ...
            try:
                ...
                await self._mount_message(SystemMessage(f"agentscli version: {__version__}"))
            except Exception:
                await self._mount_message(SystemMessage("agentscli version: unknown"))
        elif cmd == "/clear":
