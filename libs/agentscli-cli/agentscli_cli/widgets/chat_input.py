"""Chat input widget for agentscli-cli with autocomplete and history support."""
...
from agentscli_cli.widgets.autocomplete import (
    SLASH_COMMANDS,
    CompletionResult,
    FuzzyFileController,
...
from agentscli_cli.widgets.history import HistoryManager
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            history_file: Path to history file (default: ~/.agentscli/history.jsonl)
        ...
        if history_file is None:
            history_file = Path.home() / ".agentscli" / "history.jsonl"
