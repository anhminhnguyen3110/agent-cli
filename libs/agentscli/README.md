...
```bash
# pip
pip install agentscli

# uv
uv add agentscli

# poetry
poetry add agentscli
```
...
from langchain_core.tools import tool
from langchain.agents import create_agent
from agentscli.middleware.subagents import SubAgentMiddleware
...
Prior versions of agentscli separated sync and async agent factories.
