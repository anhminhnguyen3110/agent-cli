...
```python
from agentscli import MemoryMiddleware
...
if TYPE_CHECKING:
    from agentscli.backends.protocol import BACKEND_TYPES, BackendProtocol
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            sources: List of memory file paths to load (e.g., ["~/.agentscli/AGENTS.md",
                     "./.agentscli/AGENTS.md"]). Display names are automatically derived
