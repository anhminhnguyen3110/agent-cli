...
from agentscli.backends import StateBackend

# Re-export type here for backwards compatibility
from agentscli.backends.protocol import BACKEND_TYPES as BACKEND_TYPES
from agentscli.backends.protocol import (
    BackendProtocol,
    EditResult,
    SandboxBackendProtocol,
    WriteResult,
)
from agentscli.backends.utils import (
...
class FilesystemMiddleware(AgentMiddleware):
    ...
    Example:
        ...
        from agentscli.backends import StateBackend, StoreBackend, CompositeBackend
